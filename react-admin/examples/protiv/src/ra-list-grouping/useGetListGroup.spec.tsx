...
const UseGetListGroup = ({
    ...
    const hookValue = useGetListGroup(
        resource,
...
describe('useGetListGroup', () => {
    it('should call dataProvider.getList() on mount', async () => {
        ...
        render(
            <CoreAdminContext dataProvider={dataProvider}>
                <UseGetListGroup pagination={{ page: 1, perPage: 20 }} />
            </CoreAdminContext>
        );
        await waitFor(() => {
            expect(dataProvider.getListGroup).toBeCalledTimes(1);
            expect(dataProvider.getListGroup).toBeCalledWith('posts', {
                filter: {},
    ...
    //     rerender(
    //         <CoreAdminContext dataProvider={dataProvider}>
    //             <UseGetListGroup resource="comments" />
    //         </CoreAdminContext>
    //     );
    //     await waitFor(() => {
    ...
    //         >
    //             <UseGetListGroup callback={callback} />
    //         </CoreAdminContext>
    //     );
    //     await waitFor(() => {
    ...
    //     render(
    //         <CoreAdminContext dataProvider={dataProvider}>
    //             <UseGetListGroup options={{ retry: false }} callback={callback} />
    //         </CoreAdminContext>
    //     );
    //     await waitFor(() => {
    //         expect(callback).toHaveBeenCalledWith(
    ...
    //     render(
    //         <CoreAdminContext dataProvider={dataProvider}>
    //             <UseGetListGroup options={{ onSuccess: onSuccess1 }} />
    //             <UseGetListGroup
    //                 resource="comments"
    ...
    //     render(
    //         <CoreAdminContext dataProvider={dataProvider}>
    //             <UseGetListGroup options={{ onError, retry: false }} />
    //         </CoreAdminContext>
    //     );
    //     await waitFor(() => {
