...
export default (introspectionResults: IntrospectionResult) => (
    ...
    console.log(`SUPER ${raFetchMethod} ${resource.type.name} ${queryType.name} Preparing params => `, JSON.stringify(params));
    const preparedParams = prepareParams(
        params,
        queryType,
        introspectionResults
    );
    console.log(`SUPER ${raFetchMethod} ${resource.type.name} ${queryType.name} Preparing params => `, JSON.stringify(preparedParams));
